...
plot "ZnO.pdos_atm#1(Zn)_wfc#3(d)" u ($1-7.3254):($2+0) w l lw 2 lt rgb "red"   title 'Zn-3d', \
     ...
     "../1_wannier/ZnO.pdos_atm#1(Zn)_wfc#3(d)" u ($1-9.2869):($2+4) w l lw 2 lt rgb "red"   notitle,\
     "../1_wannier/ZnO.pdos_atm#3(O)_wfc#2(p)"  u ($1-9.2869):($2+4) w l lw 2 lt rgb "blue"  notitle,\
     "../1_wannier/ZnO.pdos_atm#1(Zn)_wfc#4(s)" u ($1-9.2869):($2*3+4) w l lw 2 lt rgb "orange"   notitle,\
